...
- **[`components-v03.html`](./components-v03.html)** — *Conservatory v0.3 — Component Kit*, a shadcn-style gallery of every UI primitive in the v0.3 language: buttons, inputs, selection, sliders, cards, KPIs, charts, badges, avatars, alerts, toasts, progress, dialog/sheet, popover/tooltip/menu, tabs/accordion, breadcrumb/pagination/steps, command menu, tables, lists/trees, calendar, code/kbd, empty/error, trust layer, spatial primitives, and map cartouche. Density / Room / Mode toggles wired to the same token tree as the style guide.
